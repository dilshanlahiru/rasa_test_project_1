...
class Slotoutput(Action):
 ...
 def run(self, dispatcher: CollectingDispatcher,
     ...
     slot_value1 = tracker.get_slot('pizza_size')
     slot_value2 = tracker.get_slot('pizza_type')

     dispatcher.utter_message(slot_value1)
     dispatcher.utter_message(slot_value2)
